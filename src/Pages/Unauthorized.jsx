      ...
      <div className="max-w-lg w-full p-10 bg-white rounded-2xl shadow-2xl border border-gray-200">
        ...
        <div className="flex  md:flex-row flex-col gap-3  justify-center ">
          ...
          <button
            ...
            className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
          >
            تسجيل الدخول
          </button>
        </div>
