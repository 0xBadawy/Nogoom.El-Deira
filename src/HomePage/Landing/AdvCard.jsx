...
export const AdvCard = ({ Title, Link, Img, des, category }) => {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-lg p-6 transition-all duration-300 hover:shadow-2xl hover:transform hover:scale-[1.02] group">
      <div className="flex flex-col h-full">
        ...
        <div className="flex-grow">
          ...
          <p className="text-gray-600 mb-4 line-clamp-3">{des}</p>
        </div>
